...
var nav_degrade_into_agenda_eventos = `
    <nav class="gradient">
        ...
        <% if (data.link_apresentacao){ %>
            <div class="ppts-congresso">
                <a href="<%= data.link_apresentacao %>" class="btn-floating btn-large waves-effect waves-light my-float" style="background-color: --Tealish">
                    <i class="material-icons" style="font-size: 280%;">cloud_download</i>
                </a>
            </div>
        <% } %>
    </nav>
