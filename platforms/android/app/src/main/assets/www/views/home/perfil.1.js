    ...
    <section id="perfil" class="flex fd-col h100vh overflow-hidden">
        ...
        <div class="dados flex-1 flex pos-rel">
            ...
            <form class="w100 fd-col jc-sa z-1" onsubmit="update_information(event)">
                ...
                <button type="submit" class="zerarButton w100 waves-effect">
                    <img class="icon" src="image/load.svg">&nbsp;&nbsp;
        ...
        <div class="row">
            ...
            <div class="linkCertificado">
                <div>
                    ...
                    <label>
                        <a class="elipsi-nome-cert" id-projeto="<%=login.certificados_full[j].id_projeto%>" nome-projeto="<%=login.certificados_full[j].nome_projeto%>" carga-horaria="<%=login.certificados_full[j].carga_horaria%>" href="javascript:void(0)" onclick="open_certificado(this)"> <%= login.certificados_full[j].nome_projeto%>.pdf </a>
                    </label>
                    <%}%>
                </div>
            </div>
